...
const DEFAULT_BEHIND_GRADIENT =
  'radial-gradient(farthest-side circle at var(--pointer-x) var(--pointer-y),hsla(339, 73%, 44%, 0.5) 4%,hsla(339, 73%, 44%, 0.3) 10%,hsla(339, 73%, 44%, 0.1) 50%,transparent 100%)';
        ...
        <div className="pc-inside">
          ...
          <div className="pc-content">
            <div className="pc-details">
              <h3 className="text-pink-600">{name}</h3>
